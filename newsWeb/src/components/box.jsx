...
function Box() {
    ...
    const [data,setData]  = useState({})
     useEffect(()=>{
        fetch('https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=86d619677e944791af35756435d42970')
        .then((res)=>res.json())
    ...
    return (
        ...
        <div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
          ...
          <img src="https://images.pexels.com/photos/4500661/pexels-photo-4500661.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" class="w-full h-60 object-cover rounded-lg sm:h-52 sm:col-span-2 lg:col-span-full" loading="lazy"/>
            {/* <img src="https://images.pexels.com/photos/3839694/pexels-photo-3839694.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" class="hidden w-full h-52 object-cover rounded-lg sm:block sm:col-span-2 md:col-span-1 lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy"/>
